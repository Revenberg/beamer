...
public class FindLinesInImageImplImpl implements FindLinesInImage{
    ...
    public FindLinesInImageImpl(String filename, String path, String bundle, String song) throws IOException {
        this.scaling = 1.0;
